...
./bin/a4 -input ./scenes/scene04_axes.txt       -size 500 500 -output ./images-mine/scene-4.bmp -depth ./images-mine/depth/scene-4_depth.bmp 2   50    -normals ./images-mine/normals/scene-4_normals.bmp
